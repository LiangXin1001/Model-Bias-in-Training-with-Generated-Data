...
def train_vqvae():
    # mnist = MnistDataset('train', im_path='/root/autodl-tmp/xin/datasets/CMNIST/data/train')
    # mnist_test = MnistDataset('test', im_path='/root/autodl-tmp/xin/datasets/CMNIST/data/test')
    mnist = MnistDataset('train', im_path='/root/autodl-tmp/xin/Model-Bias-in-Training-with-Generated-Data/Dataset/Colored_MNIST_Bais_train_Organized')

    mnist_test = MnistDataset('test', im_path='/root/autodl-tmp/xin/Model-Bias-in-Training-with-Generated-Data/Dataset/Colored_MNIST_Bais_test_Organized')
