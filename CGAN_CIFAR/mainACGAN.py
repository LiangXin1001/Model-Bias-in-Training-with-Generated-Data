...
for epoch in range(1,epochs+1):
    ...
    for idx, (images,labels,_) in enumerate(trainloader,0):
        ...
        real_labels = 0.7 + 0.5 * torch.rand(batch_size, device=device)
        fake_labels = 0.3 * torch.rand(batch_size, device=device)
        ...
        print("Predicted validity shape:", pvalidity.shape)
        print("Real validity label shape:", validity_label.shape)
