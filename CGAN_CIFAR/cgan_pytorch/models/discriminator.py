...
class DiscriminatorForCIFAR100(nn.Module):
    ...
    def __init__(self, image_size: int = 28, channels: int = 3, num_classes: int = 20) -> None:
        super(DiscriminatorForCIFAR100, self).__init__()
...
def discriminator_for_CIFAR100(image_size: int = 32, channels: int = 3) -> DiscriminatorForCIFAR100:
    r"""GAN model architecture from the `"One weird trick..." <https://arxiv.org/abs/1406.2661>` paper.
    """
    model = DiscriminatorForCIFAR100(image_size, channels)
